...
function h = plotRobotPose2DWithHeight(axes_h, pose, arrowColor, arrowLength)
    ...
    h2 = plot3(axes_h, arrowBody(1,:),arrowBody(2,:), arrowBody(3,:), ...
        'Color',arrowColor,'LineWidth',2); 
    h3 = plot3(axes_h, crossLine_1(1,:),crossLine_1(2,:), crossLine_1(3,:),...
        'Color',arrowColor,'LineWidth',2);
    h4 = plot3(axes_h, crossLine_2(1,:),crossLine_2(2,:), crossLine_2(3,:), ...
        'Color',arrowColor,'LineWidth',2);
    h = [h1, h2, h3, h4];
end
