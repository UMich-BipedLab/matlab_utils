% copyDependencies('change_basis.m', './standalone_lib')
function copyDependencies(start_mfile, destination)
% copy_dependencies 
...
nFiles = length(flist);
fprintf("Found %u files.   \n", nFiles)
fprintf("Copying to %s ...   \n", java.io.File(destination).getCanonicalPath)
